  ...
  @confirm="delBatch">
          ...
          <el-table :data="tableData" border stripe :header-cell-class-name="headerBg"  @selection-change="handleSelectionChange">
           <el-table-column type="selection" width="55">
            ...
            <el-table-column prop="project" label="选测项目" width="auto">
            </el-table-column>
            <el-table-column prop="shuz" label="选测数值" width="auto">
            </el-table-column>
            ...
            <el-table-column prop="xcxm" label="所属工作面" width="200">
            </el-table-column>
...
<!-- //新增提示框 -->
  ...
  <el-form label-width="80px" size="small">
    <el-form-item label="断面名称">
      ...
      <el-input v-model="form.xcxm" autocomplete="off"></el-input>
      </el-form-item>
...
methods:{
    ...
    save () {
      this.request.post('/xuanc', this.form).then((res) => {
        if (res) {
    ...
    // 删除
    del (id) {
      this.request.delete('/xuanc/' + id).then((res) => {
        if (res.data) {
    ...
    delBatch () {
      ...
      this.request.post('/xuanc/del/batch', ids).then((res) => {
        if (res.data) {
