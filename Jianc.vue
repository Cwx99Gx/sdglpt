  ...
  <div>
          <div style="margin: 10px 0">
            ...
            <el-input
              ...
              v-model="project"
            ></el-input
            ><el-button class="ml-5" type="primary" @click="loadd"
              >搜索</el-button
            >
  ...
  @confirm="delBatch">
          ...
          <el-table :data="tableData" border stripe :header-cell-class-name="headerBg"  @selection-change="handleSelectionChange">
           <el-table-column type="selection" width="55">
            ...
            <el-table-column prop="company" label="施工单位" width="200">
            </el-table-column>
            <el-table-column prop="project" label="监测项目" width="auto">
            </el-table-column>
            <el-table-column prop="shuz" label="测量数组" width="auto">
            </el-table-column>
            <el-table-column prop="start" label="开始里程" width="auto">
            </el-table-column>
            <el-table-column prop="end" label="结束里程" width="auto">
            </el-table-column>
            <el-table-column prop="jcxm" label="断面名称" width="200">
            </el-table-column>
            <el-table-column prop="creatTime" label="时间" width="auto">
            </el-table-column>
            <el-table-column label="操作" width="170">
              <template slot-scope="scope">
                <el-button type="warning" size="small" class="el-icon-edit" @click="handleEdit(scope.row)">编辑</el-button>
                <el-popconfirm
                class="ml-5"
  confirm-button-text='确定'
  cancel-button-text='取消'
...
<!-- //新增提示框 -->
  ...
  <el-form label-width="80px" size="small">
      ...
      <el-input v-model="form.jcxm" autocomplete="off"></el-input>
      </el-form-item>
...
methods:{
    ...
    save () {
      this.request.post('/jianc', this.form).then((res) => {
        if (res) {
    ...
    // 删除
    del (id) {
      this.request.delete('/jianc/' + id).then((res) => {
        if (res) {
    ...
    delBatch () {
      ...
      this.request.post('/jianc/del/batch', ids).then((res) => {
        if (res) {
